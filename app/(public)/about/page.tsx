...
export default function AboutPage() {
  return (
    <>
      <PublicHeader />
      <div className="min-h-screen bg-gradient-to-b from-white via-blue-50/30 to-white pt-16">
        {/* Hero Section */}
            ...
            <div className="prose prose-lg max-w-none">
              <Card className="p-8 border-l-4 border-primary-500">
                ...
                <p className="text-slate-700 leading-relaxed">
                  ...
                  Talent. He has been honored with the ACM Jinan Rising Star
                  Award and has received the Outstanding Doctoral Dissertation
                  Award from both Jinan and Nanjing University of Science and
                  Technology.
                </p>
              </Card>
            </div>
          ...
          <div className="container mx-auto max-w-6xl ">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <Card
                  key={index}
                  className="bg-gradient-to-b from-gray-100 to-white p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-2 border-transparent hover:border-primary-200"
                >
        ...
        <section className="py-16 px-4 ">
          <div className="relative py-20">
            ...
            <div className="relative container mx-auto max-w-4xl text-center">
              <Card className="p-12 bg-white/70 dark:bg-slate-900/70 backdrop-blur-md border border-gray-200 dark:border-slate-700 shadow-lg rounded-2xl">
