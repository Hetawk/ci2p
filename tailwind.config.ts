  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-primary-soft": "linear-gradient(135deg, #eff6ff 0%, #dbeafe 50%, #bfdbfe 100%)",
        ...
        // Hero Backgrounds
        "gradient-hero": "linear-gradient(135deg, #0f172a 0%, #1e40af 50%, #1e3a8a 100%)",
        "gradient-hero-light": "linear-gradient(135deg, #eff6ff 0%, #dbeafe 50%, #93c5fd 100%)",
        
        // Dashboard Backgrounds
        "gradient-dash": "linear-gradient(to bottom, #f8fafc 0%, #f1f5f9 100%)",
        "gradient-dash-dark": "linear-gradient(to bottom, #0f172a 0%, #1e293b 100%)",
        
        // Card Backgrounds
        "gradient-card": "linear-gradient(135deg, rgba(255,255,255,0.9) 0%, rgba(255,255,255,0.7) 100%)",
        "gradient-card-hover": "linear-gradient(135deg, rgba(59,130,246,0.1) 0%, rgba(147,197,253,0.05) 100%)",
        
        // Accent Gradients
        "gradient-ai": "linear-gradient(135deg, #a855f7 0%, #c084fc 50%, #d8b4fe 100%)",
        ...
        "gradient-mesh": "radial-gradient(at 40% 20%, #3b82f6 0%, transparent 50%), radial-gradient(at 80% 0%, #06b6d4 0%, transparent 50%), radial-gradient(at 0% 50%, #a855f7 0%, transparent 50%)",
      ...
      keyframes: {
        ...
        glowPrimary: {
          ...
          "50%": { boxShadow: "0 0 40px rgba(59, 130, 246, 0.8), 0 0 80px rgba(59, 130, 246, 0.6)" },
        },
        glowSecondary: {
          "0%, 100%": { boxShadow: "0 0 20px rgba(6, 182, 212, 0.5), 0 0 40px rgba(6, 182, 212, 0.3)" },
          "50%": { boxShadow: "0 0 40px rgba(6, 182, 212, 0.8), 0 0 80px rgba(6, 182, 212, 0.6)" },
        },
        glowAccent: {
          "0%, 100%": { boxShadow: "0 0 20px rgba(168, 85, 247, 0.5), 0 0 40px rgba(168, 85, 247, 0.3)" },
          "50%": { boxShadow: "0 0 40px rgba(168, 85, 247, 0.8), 0 0 80px rgba(168, 85, 247, 0.6)" },
        },
