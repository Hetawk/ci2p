  ...
  if (!user) {
    return (
      <div className="flex items-center gap-3">
        <Link
          href="/auth/login"
          className="px-4 py-2 text-gray-700 hover:text-pink-600 font-medium transition-colors"
        >
          Sign In
        </Link>
        <Link
          href="/auth/register"
          className="px-6 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white font-semibold rounded-full hover:from-pink-600 hover:to-purple-600 transition-all shadow-md hover:shadow-lg transform hover:scale-105"
        >
          Get Started
        </Link>
      </div>
    ...
    <div className="relative" ref={menuRef}>
      ...
      >
        ...
        <div className="relative">
          {user.image ? (
            <div className="w-10 h-10 rounded-full border-2 border-gray-200 group-hover:border-pink-300 transition-colors overflow-hidden">
              <Image
                src={user.image}
                alt={user.name || "User"}
                width={40}
            ...
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-400 to-purple-500 flex items-center justify-center text-white font-bold text-sm border-2 border-gray-200 group-hover:border-pink-300 transition-colors">
              {getInitials()}
            </div>
          )}
          {/* Online indicator */}
